...
date: 12-09-2020
description: "This article explores the two fundamental considerations when it comes to skills management. First, how do you acquire your employees’ skill data? Second, what practical value can you then generate from this wealth of information?"
author: 
    - name: Adam D McKinnon
    - name: Mikaël Wornoo
categories: [Employee Skills, Skill Management, Data, HR]
...
knitr::include_graphics("alex-kotliarskyi-QBpZGqEMsKg-unsplash.jpg")
...
knitr::include_graphics("data_pathways.jpg")
...
knitr::include_graphics("data-assets-usage.png")
