...
The current article focuses on the generation of synthetic data using R. We will examine the generation of the following three datasets:

1.  A basic random dataset;
2.  Creating a relationship between two variables; and
3.  Creating multiple relationships between variables.
