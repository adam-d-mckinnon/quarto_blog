...
date: 2024-07-06
description: "A chatbot, based on ChatGPT 4-o, that has been trained on Australian workplace legislation. Lex is intended to synthesise the complexity of legal documentation for the average person."
author: 
...
knitr::include_graphics("hammer.jpg")
```  
...
To see Lex in fullscreen mode, as opposed to a popup click and bookmark the following link: <https://embed.chatnode.ai/b9f2f0363d718df2>
