...
cleaned_annotated_text_tbl <- annotated_text_tbl |> 
                              ...
                              dplyr::mutate_at(vars(token, lemma), ~ stringr::str_to_lower(.)) |> 
...
word_rating_plot <-
    ...
    dplyr::select(token, rating, n, plot_description) |>
    dplyr::slice(1:150) |> 
...
cleaned_annotated_text_dt <- cleaned_annotated_text_tbl |> 
...
ggraph(wordnetwork, layout = "fr") +
    ...
    labs(title = "Cooccurrences within sentence", subtitle = "Nouns, Verbs & Adjective")
